...
```bash
cd /Volumes/syy2t/project/dsh-plugins/dsh-fff
...
- 源码: https://github.com/sleepinginsummer/dsh-fff
- npm: https://www.npmjs.com/package/dsh-fff
